...
insert into INCIDENTS (IncidentID, Incident_date, Complaint_date, ClientID, Description, OrderID) values (concat('INC', to_char(incidentid_seq.nextval)), '03-JAN-2020', '29-DEC-2019', 'C0001', 'Lorem ipsum sit dolor', 'OR00000000001');
insert into INCIDENTS (IncidentID, Incident_date, Complaint_date, ClientID, Description, OrderID) values (concat('INC', to_char(incidentid_seq.nextval)), '14-JAN-2020', '10-JAN-2020', 'C0002', 'Lorem ipsum sit dolor', 'OR00000000003');
insert into INCIDENTS (IncidentID, Incident_date, Complaint_date, ClientID, Description, OrderID) values (concat('INC', to_char(incidentid_seq.nextval)), '08-FEB-2020', '01-FEB-2020', 'C0003', 'Lorem ipsum sit dolor', 'OR00000000002');
insert into INCIDENTS (IncidentID, Incident_date, Complaint_date, ClientID, Description, OrderID) values (concat('INC', to_char(incidentid_seq.nextval)), '03-MAR-2020', '23-FEB-2020', 'C0004', 'Lorem ipsum sit dolor', 'OR00000000003');
insert into INCIDENTS (IncidentID, Incident_date, Complaint_date, ClientID, Description, OrderID) values (concat('INC', to_char(incidentid_seq.nextval)), '10-MAR-2020', '01-MAR-2020', 'C0005', 'Lorem ipsum sit dolor', 'OR00000000001');
insert into INCIDENTS (IncidentID, Incident_date, Complaint_date, ClientID, Description, OrderID) values (concat('INC', to_char(incidentid_seq.nextval)), '12-MAR-2020', '10-MAR-2020', 'C0006', 'Lorem ipsum sit dolor', 'OR00000000002');
insert into INCIDENTS (IncidentID, Incident_date, Complaint_date, ClientID, Description, OrderID) values (concat('INC', to_char(incidentid_seq.nextval)), '18-MAR-2020', '17-FEB-2020', 'C0007', 'Lorem ipsum sit dolor', 'OR00000000003');
insert into INCIDENTS (IncidentID, Incident_date, Complaint_date, ClientID, Description, OrderID) values (concat('INC', to_char(incidentid_seq.nextval)), '24-MAR-2020', '25-JAN-2020', 'C0005', 'Lorem ipsum sit dolor', 'OR00000000004');
insert into INCIDENTS (IncidentID, Incident_date, Complaint_date, ClientID, Description, OrderID) values (concat('INC', to_char(incidentid_seq.nextval)), '03-MAR-2020', '04-JAN-2020', 'C0004', 'Lorem ipsum sit dolor', 'OR00000000005');
insert into INCIDENTS (IncidentID, Incident_date, Complaint_date, ClientID, Description, OrderID) values (concat('INC', to_char(incidentid_seq.nextval)), '19-MAY-2020', '15-MAR-2018', 'C0003', 'Lorem ipsum sit dolor', 'OR00000000006');
insert into INCIDENTS (IncidentID, Incident_date, Complaint_date, ClientID, Description, OrderID) values (concat('INC', to_char(incidentid_seq.nextval)), '10-MAY-2019', '09-APR-2018', 'C0001', 'Lorem ipsum sit dolor', 'OR00000000007');
insert into INCIDENTS (IncidentID, Incident_date, Complaint_date, ClientID, Description, OrderID) values (concat('INC', to_char(incidentid_seq.nextval)), '25-AUG-2019', '04-JUN-2019', 'C0002', 'Lorem ipsum sit dolor', 'OR00000000008');
insert into INCIDENTS (IncidentID, Incident_date, Complaint_date, ClientID, Description, OrderID) values (concat('INC', to_char(incidentid_seq.nextval)), '14-JAN-2019', '27-DEC-2018', 'C0001', 'Lorem ipsum sit dolor', 'OR00000000009');
insert into INCIDENTS (IncidentID, Incident_date, Complaint_date, ClientID, Description, OrderID) values (concat('INC', to_char(incidentid_seq.nextval)), '01-AUG-2018', '01-AUG-2018', 'C0001', 'Lorem ipsum sit dolor', 'OR00000000010');
